...
class SentenceAnalyzer(object):
    ...
    def morphology_analysis(self, sentences):
        ...
        # psents = (sentences, org_sentences, org_sentence_space_infos, convert_output_sentences)
        # write_pickle("./result/sents_back.pickle", psents)
        sentences, org_sentences, org_sentence_space_infos, convert_output_sentences = read_pickle("./result/pickle/sents_back_dev.pickle")
        err_code, err_msg, not_convert_output_sentences = -1, "", []
